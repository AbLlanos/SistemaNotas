...
public class EducacionBasicaController {
    ...
    public String vistaAdminEducacionBasica(
        ...
        //Moficar
        String nivelFiltro = "educacionbasica";
    ...
    @GetMapping("/notas/nuevoEducacionBasica")
    public String mostrarFormularioNuevaNotaTecnico(Model model) {
        ...
        return "pages/Admin/EducacionBasica/educacionBasicaForm";
    }

    // Guardar nota (tanto nueva como editada)
    @PostMapping("/notas/guardarBasica")
    public String guardarNotas(
        ...
        return "redirect:/pages/Admin/EducacionBasica/educacionBasicaVista";
    }

    @GetMapping("/notas/editarBasica/{id}")
    ...
    @GetMapping("/periodo/{nombrePeriodo}/cursosBasica")
    @ResponseBody
    public List<CursoDTO> listarCursosPorPeriodoFiltrados(@PathVariable String nombrePeriodo) {
        ...
        List<CursoDTO> cursosFiltrados = cursos.stream()
                .filter(curso -> curso.getNivelEducativo() != null &&
                        //MODIFICAR
                        "Educacion Basica".equals(curso.getNivelEducativo().getNombre()))
